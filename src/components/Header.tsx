      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="text-xl font-bold tracking-wider text-white">
            Prime <span className="text-neutral-500">Self Drive</span>
          </div>
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            <a href="#blogs" className="text-white/90 hover:text-white text-sm tracking-wide transition-colors">Blog</a>
        ...
        <div className="absolute top-full left-0 right-0 bg-black/95 backdrop-blur-xl border-t border-white/10">
          <div className="container mx-auto px-6 py-8">
            <nav className="space-y-4">
              ...
              <a href="#blogs" className="block text-white text-xl hover:text-neutral-400 transition-colors">Blog</a>
