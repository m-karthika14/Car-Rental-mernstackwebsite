  ...
  return (
    <section ref={sectionRef} className="py-24 px-6 bg-black" id="services">
      <div className="container mx-auto">
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-24 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          {[
